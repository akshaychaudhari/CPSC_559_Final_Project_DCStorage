  ...
  render() {
    return (
      <nav style={{fontFamily: "Cursive"}} className="navbar navbar-light bg-light p-0 shadow bg-body rounded">
          ...
          <a style={{color: "#5c13ec", fontSize: "18px"}} class="nav-link" aria-current="page" href="/organization"> <span className='fa fa-users' style={{fontSize: "17px"}}></span> Organization</a>
          <form class="d-flex">
