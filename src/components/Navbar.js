...
class Navbar extends Component {
  ...
  render() {
    return (
      <nav className="navbar navbar-light bg-light p-0 text-monospace shadow bg-body rounded">
          <img src={cryptoBox} width="150" height="70" className="align-top ml-3 pt-1 pb-2" alt="CryptoBox App Logo" />
          <a style={{color: "#5c13ec", fontSize: "18px"}} class="nav-link" aria-current="page" href="#"> <span className='fa fa-home' style={{fontSize: "20px"}}></span> Home </a>
